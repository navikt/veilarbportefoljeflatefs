...
export const SETT_MARKERT_BRUKER_ALLE =
  "veilarbportefolje/portefolje/SETT_MARKERT_BRUKER_ALLE";
export const TILDEL_VEILEDER = "veilarbportefolje/portefolje/TILDEL_VEILEDER";
const TILDEL_VEILEDER_RELOAD =
  "veilarbportefolje/portefolje/TILDEL_VEILEDER_RELOAD";
const TILDEL_VEILEDER_OK = "veilarbportefolje/portefolje/TILDEL_VEILEDER_OK";
const TILDEL_VEILEDER_FEILET =
  "veilarbportefolje/portefolje/TILDEL_VEILEDER_FEILET";
const OPPDATER_ANTALL = "veilarbportefolje/portefolje/OPPDATER_ANTALL";
const NULLSTILL_FEILENDE_TILDELINGER =
  "veilarbportefolje/portefolje/NULLSTILL_FEILENDE_TILDELINGER";
const OPPDATER_ARBEIDSLISTE =
  "veilarbportefolje/portefolje/OPPDATER_ARBEIDSLISTE";
...
function updateArbeidslisteForBrukere(brukere, arbeidsliste) {
  return brukere.map(bruker => {
    const arbeidslisteForBruker = arbeidsliste.filter(
      a => a.fnr === bruker.fnr
    );
    ...
    case OPPDATER_ANTALL:
      return {
        ...
        data: {
          ...
          antallReturnert:
            state.data.antallReturnert - action.antallTilordninger
        }
      };
...
export function tildelVeileder(
  tilordninger,
  tilVeileder,
  filtergruppe,
  veilederIdent
      ...
      .then(res => {
        ...
        if (filtergruppe === ListevisningType.minOversikt) {
          dispatch({
            ...
            antallTilordninger:
              tilordninger.length - res.feilendeTilordninger.length
          });
        }
      })
      .then(() => {

...
export enum Kolonne {
    ...
    YTELSE_ARENA_GJENSTAENDE_UKER_RETTIGHET_DAGPENGER = 'gjenstaende_uker_rettighet_dagpenger',
    YTELSE_ARENA_GJENSTAENDE_UKER_VEDTAK_TILTAKSPENGER = 'gjenstaende_uker_vedtak_tiltakspenger',
    YTELSE_ARENA_VURDERINGSFRIST_AAP = 'vurderingsfrist_ytelse',
    YTELSE_ARENA_YTELSESTYPE_AAP = 'type_ytelse',
    YTELSE_ARENA_VEDTAKSPERIODE_AAP = 'vedtaksperiode',
    YTELSE_ARENA_RETTIGHETSPERIODE_AAP = 'rettighetsperiode',

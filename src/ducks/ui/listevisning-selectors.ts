...
export function getMuligeKolonner(filtervalg: FiltervalgModell, oversiktType: OversiktType): Kolonne[] {
    ...
    const tolkBehovErValgt = () => {
        return (filtervalg.tolkebehov.length > 0 || (filtervalg.tolkBehovSpraak !== undefined && filtervalg.tolkBehovSpraak !== null && filtervalg.tolkBehovSpraak.length > 0));
    };
    ...
    return ([] as Kolonne[])
        ...
        .concat(addHvis(Kolonne.NAVIDENT, oversiktType === OversiktType.enhetensOversikt && !tolkBehovErValgt()))

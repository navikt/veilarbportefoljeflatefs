...
const ARBEIDSLISTE_LAGRE_PENDING =
...
const ARBEIDSLISTE_SLETT_PENDING =
  "veilarbportefolje/slett_arbeidsliste/PENDING";

export const ARBEIDSLISTE_REDIGER_OK =
  "veilarbportefolje/rediger_arbeidsliste/OK";
const ARBEIDSLISTE_REDIGER_FEILET =
  "veilarbportefolje/rediger_arbeidsliste/FEILET";
const ARBEIDSLISTE_REDIGER_PENDING =
...
export function redigerArbeidsliste(formData, props) {
  ...
  return dispatch =>
    putArbeidsliste(
      ...
      .then(res =>
        oppdaterArbeidsListeState(
          res,
          arbeidsliste,
          props.innloggetVeileder,
          props.bruker.fnr,
          dispatch
        )
      )
...
export function slettArbeidsliste(arbeidsliste) {
  return doThenDispatch(
    () => httpArbeidsliste(arbeidsliste, "post", "delete"),
    {

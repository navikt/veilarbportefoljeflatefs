...
export const ENDRE_AKTIVITETER_OG_FJERN_TILTAK_FILTER =
  "filtrering/ENDRE_AKTIVITETER_OG_FJERN_TILTAK_FILTER";
export const SLETT_AKTIVITETER_OG_TILTAK_FILTER =
  "filtrering/SLETT_AKTIVITETER_OG_TILTAK_FILTER";
...
export default function reducer(
  state: FiltervalgModell = initialState,
  action
): FiltervalgModell {
  switch (action.type) {
    case CLEAR_FILTER:
...
export function velgMineFilter(

...
export const AVMARKER_SISTE_VALGT_MINE_FILTER =
  "lagretfilter_velg/AVMARKER_SISTE_VALGT_MINE_FILTER";

export const MARKER_VEILEDER_GRUPPE =
  "lagretfilter_velg/MARKER_VEILEDER_GRUPPE";
export const AVMARKER_VEILEDER_GRUPPE =
  "lagretfilter_velg/AVMARKER_VEILEDER_GRUPPE";

export const APEN_MINE_FILTER_MODAL =
  "lagretfilter_velg/APEN_MINE_FILTER_MODAL";
export const LUKK_MINE_FILTER_MODAL =
  "lagretfilter_velg/LUKK_MINE_FILTER_MODAL";
...
export default function reducer(
  state: LagretFilterUIState = initialState,
  action
): LagretFilterUIState {
  switch (action.type) {
...
// Action Creators
export function markerMineFilter(
  filterVerdi: LagretFilter,
  filtergruppe: string
) {
  return {
...
export function markerValgtVeilederGruppe(
  filterVerdi: LagretFilter,
  filtergruppe: string
) {
  return {

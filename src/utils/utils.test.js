...
describe("Date utils", () => {
  describe("Utlopsdato aktiviteter", () => {
    it("finn neste utlopsdato", () => {
      ...
      expect(nesteUtlopsdato.toUTCString()).toBe(
        new Date(nesteDatoString).toUTCString()
      );
    });
  ...
  describe("Utledning av valgte aktiviteter", () => {
    it("skal utlede navn på valg aktivitet", () => {
      ...
      expect(
        utledValgteAktivitetsTyper(brukerAktiviteter, aktivitetFiltervalg)
      ).toStrictEqual({ a2: "2050-08-21T13:22:00Z" });
    });
  ...
  describe("Sjekke oppfølging startet-dato", () => {
    it("Dato er før 04.12.2017, skal returnere null", () => {
      expect(oppfolgingStartetDato("2016-02-01")).toStrictEqual(
        new Date("2017-12-04")
      );
    ...
    it("skal returnere gitt dato", () => {
      expect(oppfolgingStartetDato("2019-02-01")).toEqual(
        new Date("2019-02-01")
      );
    });
  });

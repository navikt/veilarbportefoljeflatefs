...
import '../style-gammel.less';import { useFetchStatusTall } from '../hooks/portefolje/use-fetch-statustall';

function VeiledereSideGammel() {
                    ...
                    <section>
                        <div id="oversikt-sideinnhold" role="tabpanel" className="oversikt-sideinnhold__gammel">
                            <div className="status-filter-kolonne__gammel">
                                <PanelBase className="blokk-xxxs sok-veileder__gammel">
                                    <Undertittel>
                                        Søk veileder
                                    </Undertittel>
                                    <FiltreringVeiledere/>
...
export default VeiledereSideGammel;

...
function VeilederTabell(props: VeiledereTabellProps) {
  ...
  const sorterPaaPortefoljeStr =
    currentSortering.property === "portefoljestorrelse";
    ...
    if (sorterPaa) {
      if (currentSortering.direction === "ascending") {
        return (
          <PilAscending
            className={className}
            data-testid="sorteringspil_ascending"
          />
        );
        ...
        return (
          <PilDescending
            className={className}
            data-testid="sorteringspil_descending"
          />
        );
      }
    }
              ...
              <th scope="col" className="tabellheader">
                <div className="tabellheader__lenke">
                  <button
                    ...
                    aria-label={
                      sorterEtternavn ? currentSortering.direction : "inaktiv"
                    }
                  >
                    Etternavn
                  </button>

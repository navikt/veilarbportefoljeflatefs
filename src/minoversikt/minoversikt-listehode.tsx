...
function MinOversiktListeHode({
  ...
  const aapRettighetsperiode = erAapYtelse
    ? ytelseAapSortering[ytelse!].rettighetsperiode
    : "";
  ...
  const ytelseSorteringHeader =
    ytelseUtlopsdatoNavn === "utlopsdato" || erAapYtelse
      ? "Gjenstående uker vedtak"
      : "Gjenstående uker rettighet";
    ...
    <div className="brukerliste__header brukerliste__sorteringheader typo-undertekst">
      ...
      <div className="brukerliste__innhold">
        ...
        <SorteringHeader
          ...
          skalVises={
            ytelseFilterErAktiv(ytelse) &&
            valgteKolonner.includes(Kolonne.UTLOP_YTELSE)
          }
          className="sortering-header__dato col col-xs-2"
        ...
        <SorteringHeader
          ...
          rekkefolge={sorteringsrekkefolge}
          erValgt={
            sorteringsfelt === Sorteringsfelt.START_DATO_FOR_AVTALT_AKTIVITET
          }
        ...
        <SorteringHeader
          ...
          erValgt={
            sorteringsfelt ===
            Sorteringsfelt.NESTE_START_DATO_FOR_AVTALT_AKTIVITET
          }
        ...
        <SorteringHeader
          ...
          rekkefolge={sorteringsrekkefolge}
          erValgt={
            sorteringsfelt === Sorteringsfelt.FORRIGE_DATO_FOR_AVTALT_AKTIVITET
          }

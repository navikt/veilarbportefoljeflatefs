...
export const HuskelappForPanel = ({huskelapp, bruker, onEndreHuskelapp}: Props) => (
    <HuskelappPostitWrapper>
        <Heading level="3" size="xsmall" spacing>
            {huskelapp?.frist ? `Frist: ${fomraterTilNorskDateString(huskelapp.frist)}` : 'Ingen frist satt'}
        </Heading>
        ...
        <Detail spacing>
            <i>
                Endret {fomraterTilNorskDateString(huskelapp?.endretDato)} av {huskelapp?.endretAv}
            </i>
        </Detail>

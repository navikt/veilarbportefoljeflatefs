...
import { MinOversiktWrapperGammel } from './min-oversikt-wrapper-gammel';

function MinoversiktSideGammel() {
                    ...
                    <MinOversiktWrapperGammel>
                        ...
                        <div className="liste-kolonne__gammel">
                            ...
                            <MinoversiktTabell
                                ...
                                settSorteringOgHentPortefolje={settSorteringogHentPortefolje}
                                classNameWrapper={flereEnnAntallBrukere(0) ? 'portefolje__container__gammel' : 'portefolje__container__tom-liste__gammel'}
                            />
...
export default MinoversiktSideGammel;

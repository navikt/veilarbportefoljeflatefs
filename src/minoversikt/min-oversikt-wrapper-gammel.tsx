...
export function MinOversiktWrapperGammel(props: PropsWithChildren<{}>) {
    ...
    return (
        <section className={visesAnnenVeiledersPortefolje ? 'annen-veileder' : ''}>
            ...
            <div id="oversikt-sideinnhold" role="tabpanel" className="oversikt-sideinnhold__gammel portefolje-side__gammel">
                {props.children}
            </div>
        </section>
    );

...
export function useModalControllerSelector() {
  const serverfeilModalSkalVises = useSelector(
    (state: AppState) => state.serverfeilModal.aarsak
  );
  const feilmeldingModal = useSelector(
    (state: AppState) => state.feilmeldingModal
  );

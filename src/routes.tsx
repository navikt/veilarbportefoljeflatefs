  ...
  return (
    <div className="portefolje">
      <div className="maincontent side-innhold">
        <Innholdslaster
          avhengigheter={[enhettiltak, veiledere, portefoljestorrelser]}
        >
          <Switch>
            <Route
              path="/enhet"
            ...
            <Route
              path="/veiledere"
              component={
                erRedesignFeatureTogglePa ? Ny_veiledereSide : VeiledereSide
              }
            />
            <Route
              path="/portefolje/:ident"
              component={
                erRedesignFeatureTogglePa ? Ny_MinoversiktSide : MinOversiktSide
              }
            />
            <Route
              path="/portefolje"

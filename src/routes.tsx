        ...
        <div className="portefolje">
            <div className="maincontent side-innhold">
                <AlertStripeFeil className="stor-feil-modal">
                    ...
                    href="https://navno.sharepoint.com/sites/intranett-driftsmeldinger/SitePages/Det-kan-oppleves-treghet-i-Modia-og-Gosys.aspx">følge
                    med på hvordan det går</Lenke>
                </AlertStripeFeil>

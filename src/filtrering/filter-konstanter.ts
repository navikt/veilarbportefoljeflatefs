...
export const PERMITTERTE_UTEN_OPPFOLGINGSVEDTAK = 'PERMITTERTE_UTEN_OPPFOLGINGSVEDTAK';
...
export const ferdigfilterListe = {
    ...
    PERMITTERTE_UTEN_OPPFOLGINGSVEDTAK: 'Permitterte uten oppfølgingsvedtak',
};

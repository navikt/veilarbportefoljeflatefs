...
function FlyttKnappWraper({showUpBtn, showDownBtn, onClickUp, onClickDown}: FlyttKnappWraperProps) {
    return (
        <div className="flytt-knapper" aria-hidden="true">
            {showUpBtn && (
                <div className="flytt-knapp" role="button" aria-disabled="true" onClick={onClickUp}>
                    <PilAscending />
                </div>
            )}
            {showDownBtn && (
                <div className="flytt-knapp" role="button" aria-disabled="true" onClick={onClickDown}>
                    <PilDescending />
                </div>
            )}
        </div>

...
import NyFiltreringStatusIkkePermitterteEtterNiendeBrukere from "./filtrering-status-components/ny_ikke-permitterte-brukere";
...
export function NyFiltreringStatus(props: FiltreringStatusProps) {
  ...
  function dispatchArbeidslisteKategoriChange(
  ...
  function handleRadioButtonChange(e: React.ChangeEvent<HTMLInputElement>) {
    const nyeFerdigfilterListe = leggTilFerdigFilter(
      ferdigfilterListe!,
      e.target.value
    );
    dispatchFiltreringStatusChanged(nyeFerdigfilterListe);
        ...
        <div className="permittering_checkboksgruppe">
          <div className="hjelpetekst__wrapper">
            <Hjelpetekst id="hjelpetekst" type={PopoverOrientering.Hoyre}>
              <p>
                <b>Alle utenom permitterte etter 09.03.2020:</b> Alle brukere,
                uavhengig av situasjon ved registrering og tidspunkt for
                registrering, men ekskludert de som har registrert seg som
                permittert etter 9. mars 2020.
              </p>
              <p>
                <b>Permitterte etter 09.03.2020:</b> Brukere som har registrert
                seg etter 9. mars og som har svart at de er permittert.
              </p>
              <p>

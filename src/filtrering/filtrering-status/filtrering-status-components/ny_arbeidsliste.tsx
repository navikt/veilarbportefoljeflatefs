...
function NyFilterStatusMinArbeidsliste(
  props: FilterStatusMinArbeidslisteProps
) {
      ...
      {props.checked && (
        <div className="minArbeidsliste__kategori-checkboxwrapper">
          <NyBarInputCheckbox
            labelTekst={
              <>
                ...
                <span
                  ...
                  title="Arbeidslistekategori blå"
                >
                  Blå
                </span>
              </>
            ...
            checked={
              props.checked &&
              props.ferdigfilterListe.includes(KategoriModell.BLA)
            }
          ...
          <NyBarInputCheckbox
            ...
            checked={
              props.checked &&
              props.ferdigfilterListe.includes(KategoriModell.LILLA)
            }
          ...
          <NyBarInputCheckbox
            ...
            checked={
              props.checked &&
              props.ferdigfilterListe.includes(KategoriModell.GRONN)
            }
          ...
          <NyBarInputCheckbox
            labelTekst={
              <>
                ...
                <span
                  className="arbeidslistetekst"
                  title="Arbeidslistekategori gul"
                >
                  Gul
                </span>
              </>
            ...
            checked={
              props.checked &&
              props.ferdigfilterListe.includes(KategoriModell.GUL)
            }

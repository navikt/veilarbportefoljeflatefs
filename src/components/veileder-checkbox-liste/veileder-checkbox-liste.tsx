...
import {PortefoljeFilterAlternativ, PortefoljeFilter, VeilederModell} from '../../model-interfaces';
...
function VeilederCheckboxListe({nullstillInputfelt}: VeilederCheckboxListeProps) {
    const filtervalg: PortefoljeFilter = useSelector((state: AppState) => state.filtreringVeilederoversikt);
    ...
    const filterId: PortefoljeFilterAlternativ = 'veiledere';

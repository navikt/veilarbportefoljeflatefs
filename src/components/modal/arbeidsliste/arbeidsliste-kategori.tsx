        ...
        return (
          <div className="arbeidslistekategori">
            ...
            <Arbeidslistekategori
              ...
              name={props.name}
              onChange={() =>
                form.setFieldValue(field.name, KategoriModell.BLA)
              }
            ...
            <Arbeidslistekategori
              ...
              name={props.name}
              onChange={() =>
                form.setFieldValue(props.name, KategoriModell.LILLA)
              }
            ...
            <Arbeidslistekategori
              ...
              name={props.name}
              onChange={() =>
                form.setFieldValue(props.name, KategoriModell.GRONN)
              }
            ...
            <Arbeidslistekategori
              ...
              name={props.name}
              onChange={() =>
                form.setFieldValue(props.name, KategoriModell.GUL)
              }

...
import {
  skjulModal,
  VIS_FJERN_ARBEIDSLISTE_MODAL,
  visFjernArbeidslisteModal
} from "../../../ducks/modal";
...
function ArbeidslisteModalRediger({
  ...
  const laster =
    arbeidslisteStatus !== undefined && arbeidslisteStatus !== STATUS.OK;
...
export function oppdaterArbeidsListeState(
  res,
  arbeidsliste,
  innloggetVeileder,
  fnr,

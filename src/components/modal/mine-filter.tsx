export function harGjortEndringerIFilterValg(
...
export function harGjortEndringerIGruppeNavn(
  gruppeNavn: string,
...
export function veilederlisterErLik(
  lagretVeilederGruppe: string[],

...
import {getTitle, getTour} from '../tour-modal/tour-modal-custom/tour-modal-custom';
...
function SanityTourModal(props: TourModalProps) {
    ...
    // const modalName = props.stepper.filter(tittel => {
    //     return tittel;
    // });
    //
...
export default SanityTourModal;

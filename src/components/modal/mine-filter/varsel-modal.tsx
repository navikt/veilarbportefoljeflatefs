  ...
  return (
    ...
    >
      ...
      <HiddenIfNormalTekst hidden={props.modalType !== ErrorModalType.LAGRE}>
        Det oppsto en feil, og filteret <b>{props.filterNavn}</b> kunne ikke
        opprettes. Prøv igjen senere.
      </HiddenIfNormalTekst>
      <HiddenIfNormalTekst
        hidden={props.modalType !== ErrorModalType.OPPDATERE}
      >
        Det oppsto en feil, og filteret <b>{props.filterNavn}</b> kunne ikke
        lagres. Prøv igjen senere.
      </HiddenIfNormalTekst>
      <HiddenIfNormalTekst hidden={props.modalType !== ErrorModalType.SLETTE}>
        Det oppsto en feil, og filteret <b>{props.filterNavn}</b> kunne ikke
        slettes. Prøv igjen senere.
      </HiddenIfNormalTekst>
      <Hovedknapp
        mini

...
const stepsNyKolonne: Step[] = [
  ...
  },
  {
    ...
    tekst:
      "Dersom det ikke er plass til å vise alle kolonner samtidig, kan du bruke «Velg kolonner»."
  }
];
...
const stepsVeilederverktoy: Step[] = [
  {
    ...
    tekst:
      "Legg til/redigere arbeidsliste og tildel veileder finner du nå i Veilederverktøy."
  },
  {
    tittel: "Arbeidslisteikon",
    bilde: veilederverktoy2,
    tekst:
      "Du kan også klikke på ikonet for arbeidslisten for å legge til, se og redigere kommentaren."
  },
  {
...
const stepsPermitterte: Step[] = [
  {
    ...
    tekst: (
      <>
        Filteret viser alle brukere, uavhengig av situasjon og når de
        registrerte seg, <b>ekskludert</b> de som er permittert etter 9. mars.
        Filteret kan kombineres med andre statusfiltre.
      </>
    )
  },
  {
    ...
    tekst: (
      <>
        Filteret viser <b>kun</b> de som har svart at de er permittert eller
        blir permittert og har registrert seg etter 9. mars. Du kan kombinere
        filteret med f.eks. "Venter på svar fra NAV”.
      </>
    )
  },
  {

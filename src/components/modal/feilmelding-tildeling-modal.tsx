...
function FeilmeldingTildelingModal(props: FeilmeldingBrukereModalProps) {
  return (
    ...
    >
      ...
      <Normaltekst className="blokk-s">
        Det kan skyldes manglende tilgang på bruker(e), eller at veilederen
        allerede er tildelt brukeren(e).
      </Normaltekst>
      ...
      {props.fnrSuksess && props.fnrSuksess.length > 0 && (
        <div className="tildeling-veileder-modal__vellykkedebrukere">
          ...
          <Normaltekst className="blokk-s">
            Det kan ta noe tid før oversikten blir oppdatert med tildelt
            veileder.
          </Normaltekst>
        </div>
      )}

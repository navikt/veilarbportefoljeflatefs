    ...
    },
    {
        ...
        children: (
            <>
                <ul>
                    <li>
                        Kolonnetitler og funksjoner i listen står nå fast øverst på siden når du blar nedover. Da ser du
                        og kan bruke dem uansett hvor du er i listen.
                    </li>
                    <li>
                        Avhukingsboksen for å velge alle brukerne i listen står nå på samme rad som de sorterbare
                        kolonnetitlene.
                    </li>
                </ul>
            </>

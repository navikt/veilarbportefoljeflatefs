...
const endringslogginnhold: EndringsloggInnlegg[] = [
    {
        ...
        tittel: 'Filtre på svar fra registrering om utdanning',
        featureToggleName: 'veilarbportefolje.utdanning_filter',
        versjonId: '16.11.20',
        children: (
            <>
                <p>
                    Nå kan du filtrere på svarene brukere oppga i registreringen på spørsmålene om utdanning. Dette kan
                    hjelpe deg med å identifisere og prioritere hvilke brukere som kan ha behov for veiledning om
                    utdanning.
                </p>
                <p>Filterene ligger i fanen lengst til høyere under "Svar fra registrering"</p>

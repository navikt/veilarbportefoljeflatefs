...
const endringslogginnhold: EndringsloggInnlegg[] = [
  {
    ...
    children: (
      <>
        <ul>
          <li>
            Nå kan du bestemme rekkefølgen på filtrene i Mine filter. Klikk på
            hengelåssymbolet for å endre rekkefølgen.
          </li>
          <li>
            Filtrene er lagt i klikkbare faner med ikoner. Da må du skrolle
            mindre og får raskere tilgang til filtrene. Filtrene ligger fast på
            siden slik at du alltid ser dem når du scroller i listen. Du kan
            lukke filtermenyen dersom du ønsker større plass til listen.
          </li>
        </ul>
      </>
    )
  ...
  },
  {
    ...
    children: (
      <>
        <p>
          Filtrene ligger i gruppen "Status og brukergrupper" under "Filter".
        </p>
        <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    versjonId: "26.06.20",
    tekst:
      "Brukere som svarer i registreringen at de har problemer med å søke eller være i jobb (profilert til “Behov for AEV”), får et spørsmål om hvordan de ønsker å fortelle mer om sin situasjon. Nå kan bruker også velge videomøte som alternativ.",
    children: (
      <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    versjonId: "22.06.20",
    tekst:
      "Mange av de permitterte har fått endring i sin situasjon, og etiketten «Permittert etter 9. mars» er derfor nå fjernet. Du kan fremdeles finne de som har registrert seg etter 9. mars og som har svart «Er permittert eller kommer til å bli permittert» ved å benytte filteret «Permittert etter 09.03.2020».",
    children: (
      <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    versjonId: "05.05.20",
    tekst:
      "Nå kan du filtrere på de ulike fargene på arbeidslisteikonet. Når du velger “Min arbeidsliste” ser du de nye filtervalgene."
  },
  {
    dato: "4. mai 2020",
    ...
    versjonId: "04.05.20",
    tekst:
      "Nettmøte har endret navn til videomøte i aktivitetsplanen. Hvis du velger videomøte, så ligger det nå en lenke til rutinen for videomøte. Brukeren ser ikke denne lenken."
  },
  {
    dato: "6. april 2020",
    ...
    versjonId: "06.04.20",
    tekst:
      'Nå kan du filtrere frem brukere basert på situasjonen de har oppgitt på registreringstidspunktet. Filteret heter "Svar fra registrering" og ligger under filtergruppen "Situasjon", og du kan kombinere filteret med f.eks. "Trenger vurdering".',
    children: (
      <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    versjonId: "03.04.20",
    tekst:
      "Når du starter på en melding i dialogen vil denne nå lagres hos deg i en kort tid (24 timer). Du kan da besøke andre sider samtidig som du jobber med teksten, uten å miste noe."
  },
  {
    dato: "2. april 2020",
    ...
    versjonId: "02.04.20",
    tekst:
      "Du kan nå filtrere på brukere som har registrert seg etter 9. mars og oppgitt at de er permittert i Enhetens oversikt og Min oversikt i Modia. Brukerne vises også med en etikett i oversikten og på visittkortet over aktivitetsplanen.",
    children: (
      <>
        <TourModalButton
  ...
  },
  {
    ...
    versjonId: "18.03.20",
    tekst:
      "Brukere som registrerer seg med situasjonen «Er permittert eller kommer til å bli permittert» får nå en automatisk melding i dialogen om hva de nå bør gjøre.",
    children: (
      <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    children: (
      <ul>
        <li>
          Du kan nå merke kommentaren i arbeidslisten med fire ulike farger. Det
          kan være nyttig for å organisere og prioritere arbeidslisten. Du kan
          sortere listen etter farge. Du kan endre standardfargen når du legger
          brukeren til arbeidslisten første gang, eller ved å redigere
          eksisterende kommentar.
        </li>
        <li>
          Bruker får nå informasjon i dialog om at svartiden kan bli lenger enn
          vanlig på grunn av situasjonen rundt korona.
        </li>
      </ul>
    )
  },
  {
    ...
    versjonId: "13.03.20",
    tekst:
      'På aktiviteten "møte" i aktivitetsplanen kan du nå endre møteform, selv om møtet er satt til «Avtalt med NAV». Husk å sende en dialogmelding til brukeren om endringen du gjør.'
  },
  {
    dato: "5. mars 2020",
    ...
    children: (
      <>
        <ul>
          ...
          <li>
            På store skjermer vises innholdet i aktiviteten samtidig som
            dialogen
          </li>
  ...
  },
  {
    ...
    tekst:
      "Veiledergruppene vises nå også i veilederoversikten. Når du velger en gruppe ser du veilederne i gruppen, og antall brukere hver veileder er tildelt."
  },
  {
    dato: "3. mars 2020",
    versjonId: "03.03.20",
    ...
    tekst:
      "Funksjon for legge brukeren til arbeidslisten og tildele veileder ligger nå i Veilederverktøy. Du kan også klikke på arbeidslisteikonet for å legge til, se og redigere kommentaren i arbeidslisten.",
    children: (
      <>
        <TourModalButton
  ...
  },
  {
    ...
    tekst:
      "Nå kan du registrere brukernes behov for tilrettelegging under Detaljer. Det gjør det enklere å koble disse brukerne sammen med arbeidsgivere som kan inkludere. Brukerne blir søkbare i kandidatsøket i Rekrutteringsbistand. ",
    children: (
      <>
        <EndringsloggLinkMedIkon
  ...
  },
  {
    ...
    children: (
      <>
        <ul>
          <li>
            Kolonnetitler og funksjoner i listen står nå fast øverst på siden
            når du blar nedover. Da ser du og kan bruke dem uansett hvor du er i
            listen.
          </li>
          <li>
            Avhukingsboksen for å velge alle brukerne i listen står nå på samme
            rad som de sorterbare kolonnetitlene.
          </li>
        </ul>
      </>
    )
  },
  {
    ...
    tekst:
      "Når du filtrerer på ytelse har det vært en funksjonalitet for å se et stolpediagram som viser antall personer med ytelsen fordelt på tidsperioder.",
    children: (
      <p>Funksjonaliteten har vært lite brukt og er derfor nå fjernet.</p>
    )
  },
  {
    ...
    tekst:
      "Nå kan du opprette grupper av veiledere i «Enhetens oversikt». Det gjør det enklere å få oversikt over status til brukerne i avdelinger og team på NAV-kontoret.",
    children: (
      <>
        <EndringsloggLinkMedIkon
...
export function mapRemoteToState(
  ...
  return endringslogginnhold.map(el => {
    ...
    return {
      ...el,
      sett: settRemote,
      erEndringsloggFeaturePa: el.featureToggleName
        ? features[el.featureToggleName]
        : true
    };
  });
}

...
class TilbakemeldingFab extends React.Component<
  StateProps,
  TilbakemeldingFabState
> {
  ...
  harTidligereSendtTilbakemelding = () => {
    return (
      window.localStorage.getItem(this.tilbakemeldingLocalStorageName()) != null
    );
  };
  ...
  render() {
    ...
    if (
      ...
      this.harTidligereSendtTilbakemelding()
    ) {
      return null;
    }
    ...
    return (
      ...
      >
        <div
          ...
          data-testid={
            isModalOpen
              ? "tilbakemelding_fab_knapp_trykket"
              : "tilbakemelding_fab_knapp"
          }
        >
          <img

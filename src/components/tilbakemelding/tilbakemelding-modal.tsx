...
class TilbakemeldingModal extends React.Component<
  TilbakemeldingModalProps,
  TilbakemeldingModalState
> {
    ...
    return (
      <>
        ...
        <Normaltekst className="tilbakemelding-modal__ingress">
          Vi gjør en kartlegging av dialogen. Hvor fornøyd er du med den
          digitale dialogen? Svarene er anonyme.
        </Normaltekst>
  ...
  renderTakkMelding = () => {
    return (
      <div className="tilbakemelding-modal__takk-melding">
        ...
        />
        <Element>
          Takk for at du tok deg tid til å gi tilbakemelding. Vi bruker
          innspillene til å forbedre løsningen.
        </Element>
      </div>
    );
  };
    ...
    return (
      ...
      >
        <div
          ...
          data-testid={
            harSendt ? "tilbakemelding_modal_takk" : "tilbakemelding_modal"
          }
        >

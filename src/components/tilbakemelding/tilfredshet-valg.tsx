...
class TilfredshetValg extends React.Component<
  TilfredshetValgProps,
  TilfredshetValgState
> {
  constructor(props: TilfredshetValgProps) {
    super(props);

    this.state = {
      tilfredshet: props.defaultTilfredshet ? props.defaultTilfredshet : 0
    };
  }
    ...
    return (
      <div className={classNames("tilfredshet-valg__wrapper", className)}>
        <img
          ...
          className={this.hentKlasserForIkon(1)}
          onClick={() => this.handleTilfredshetChanged(1)}
          ...
          data-testid="tilfredshet-ikon_1"
        />
        <img
          alt="Lite tilfreds"
          className={this.hentKlasserForIkon(2)}
          onClick={() => this.handleTilfredshetChanged(2)}
          ...
          data-testid="tilfredshet-ikon_2"
        />
        <img
          alt="Helt ok tilfreds"
          className={this.hentKlasserForIkon(3)}
          onClick={() => this.handleTilfredshetChanged(3)}
        ...
        <img
          alt="Tilfreds"
          className={this.hentKlasserForIkon(4)}
          onClick={() => this.handleTilfredshetChanged(4)}
        ...
        />
        <img
          alt="Veldigt tilfreds"
          className={this.hentKlasserForIkon(5)}
          onClick={() => this.handleTilfredshetChanged(5)}

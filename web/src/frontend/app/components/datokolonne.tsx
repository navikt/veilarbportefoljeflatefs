...
function DatoKolonne({ dato, skalVises = true}: DatokolonneProps) {
    ...
    if (!dato) {
        return (
            ...
            <span style={{ visibility: 'hidden' }} className="brukerliste__panelelement col col-xs-1">
    ...
    return (
        <span className="brukerliste__panelelement col col-xs-1">{dato.toLocaleDateString(['nb-no', 'nn-no', 'en-gb', 'en-us'], options)}</span>
    );
}

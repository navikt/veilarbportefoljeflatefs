package no.nav.fo.veilarbportefoljeflatefs.provider.filter;
...
import static no.nav.fo.veilarbportefoljeflatefs.provider.sikkerhet.XsrfUtils.sjekkXsrfToken;
import static no.nav.fo.veilarbportefoljeflatefs.provider.sikkerhet.XsrfUtils.xsrfCookie;

...
describe('Annen veileder', () => {
    ...
    it('Gå inn til annen veileders oversikt via tabellen', () => {
        ...
        cy.getByTestId('veilederoversikt_navn_lenke').contains('Testesen, Testias').click();
    ...
    it('Søk veileder i veilederoversikt', () => {
        ...
        cy.getByTestId('veilederoversikt_sok-veileder_veilederliste')
            .find('[data-testid^="veilederoversikt_sok-veileder_veilederliste_element_"]')
        ...
        cy.getByTestId('veilederoversikt_alertstripe_info')
            ...
            .should('be.visible');
        cy.getByTestId('veilederoversikt_sok-veileder-input').click().clear().type(veilederSomfinnes);
        cy.getByTestId('veilederoversikt_sok-veileder_veilederliste')
            .find('[data-testid^="veilederoversikt_sok-veileder_veilederliste_element_"]')
            .should('have.length', 1);
        cy.getByTestId('veileder-checkbox-filterform_nullstill-knapp').should('be.disabled');
        cy.getByTestId('veilederoversikt_veilederliste_tbody').children().should('have.length', 41);
        ...
        cy.getByTestId('veileder-checkbox-filterform_nullstill-knapp').should('be.enabled').click();

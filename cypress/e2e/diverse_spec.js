...
describe('Diverse', () => {
    ...
    it('Paginering', () => {
        ...
        cy.getByTestId('se-flere_knapp').should('be.visible').click();
        cy.wait(1000);
        cy.get('.brukerliste').children().should('have.length', 123);
        cy.getByTestId('se-faerre_knapp').should('be.visible').click();
    ...
    it('Tildel veileder', () => {
        ...
        cy.wait(1000);
        cy.getByTestId('modal-suksess_tildel-veileder').should('be.visible').click();
        cy.getByTestId('modal-suksess_tildel-veileder').should('not.exist');
    });

describe("Lag én ny arbeidsliste og sjekk validering", () => {
  ...
  it("Klikk lagre med tom tittel og tom kommentar", () => {
    cy.getByTestId("modal_arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
    cy.getByTestId("modal_arbeidsliste_form").contains(
      "Du må fylle ut en tittel"
    );
    cy.getByTestId("modal_arbeidsliste_form").contains(
      "Du må fylle ut en kommentar"
    );
  });
  it("Legg inn tittel, sjekk at validering er borte", () => {
    ...
    cy.getByTestId("modal_arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
    cy.getByTestId("modal_arbeidsliste_form").should(
      "not.contain",
      "Du må fylle ut en tittel"
    );
  });
...
describe("Lag to nye arbeidslister", () => {
  ...
  it("Legg inn tittel, kommentar, dato og blå kategori på andre arbeidsliste", () => {
    ...
    cy.getByTestId("modal_arbeidsliste_kommentar_1").type(
      "Team Voff er best i test hehehe"
    );
    cy.getByTestId("modal_arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
  ...
  it(`Det eksisterer to flere brukere med arbeidsliste`, () => {
    cy.get("[data-cy=brukerliste_element_arbeidsliste]")
      ...
      .then(() => {
        expect(antallMedArbeidslisteEtterOppretting).to.be.equals(
          antallMedArbeidsliste + 2
        );
      });
  });
});
...
describe("Rediger arbeidsliste", () => {
  ...
  it("Ny tittel og kommentar skal leses i chevron", () => {
    ...
    cy.getByTestId("chevron_arbeidslisteinnhold_kommentar").contains(
      nyKommentar
    );
  });
});
...
describe("Slett arbeidsliste via fjern-knapp", () => {
  ...
  it("Klikk bekreft", () => {
    cy.getByTestId("modal_varsel_fjern-fra-arbeidsliste_bekreft-knapp")
      .should("be.visible")
      .click();
    cy.getByTestId("modal_varsel_fjern-fra-arbeidsliste_bekreft-knapp").should(
      "not.be.visible"
    );
  });
...
describe("Sjekk validering i rediger arbeidsliste-modal", () => {
  ...
  it("Fjern tittel og kommentar og klikk Lagre", () => {
    ...
    cy.getByTestId("modal_rediger-arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
    cy.getByTestId("modal_rediger-arbeidsliste_form").contains(
      "Du må fylle ut en tittel"
    );
    cy.getByTestId("modal_rediger-arbeidsliste_form").contains(
      "Du må fylle ut en kommentar"
  ...
  it("Legg til tittel, sjekk at valideringen er borte", () => {
    ...
    cy.getByTestId("modal_rediger-arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
    cy.getByTestId("modal_rediger-arbeidsliste_form").should(
      "not.contain",
      "Du må fylle ut en tittel"
    );
  });
  it("Legg til kommentar, sjekk at valideringen er borte", () => {
    cy.getByTestId("modal_arbeidsliste_kommentar").type(
      "Her er en kjempefin kommentar truddelu"
    );
    cy.getByTestId("modal_rediger-arbeidsliste_lagre-knapp")
      .contains("Lagre")
      .click();
...
describe("Avbryt redigering, ingen endringer lagret", () => {
  ...
  it("Tittel og kommentar skal være som det var før", () => {
    cy.getByTestId("chevron_arbeidslisteinnhold_tittel").should(
      "contain",
      tittel
    );
    cy.getByTestId("chevron_arbeidslisteinnhold_kommentar").should(
      "contain",
      kommentar
    );
  });

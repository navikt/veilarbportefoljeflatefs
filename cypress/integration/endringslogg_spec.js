describe('Endringslogg', () => {
    ...
    it('Åpne stepper', () => {
        ...
        cy.getByTestId('endringslogg_se-hvordan-knapp').contains('Se hvordan').first().click();
    ...
    it('Klikk gjennom stegviseren med neste og ferdig', () => {
        ...
        cy.getByTestId('endringslogg_neste-knapp').contains('Neste').click();
        ...
        cy.getByTestId('endringslogg_stegviser').then($element => {
            if ($element.find(".stegviser__steg").length === 3) {
                return cy.getByTestId('endringslogg_neste-knapp').contains('Neste').click();
            }
        });

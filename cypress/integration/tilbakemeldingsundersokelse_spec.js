describe("Spørreundersøkelse", () => {
  ...
  it("Legg igjen tilbakemelding", () => {
    cy.getByTestId("tilfredshet-ikon_5")
      .should("be.visible")
      .click();
    cy.getByTestId("tilfredshet-ikon_5").should(
      "have.class",
      "tilfredshet-valg__ikon--valgt"
    );
    cy.getByTestId("tilfredshet-ikon_4").should(
      "have.class",
      "tilfredshet-valg__ikon--ikke-valgt"
    );
    cy.getByTestId("tilfredshet-ikon_3").should(
      "have.class",
      "tilfredshet-valg__ikon--ikke-valgt"
    );
    cy.getByTestId("tilfredshet-ikon_2").should(
      "have.class",
      "tilfredshet-valg__ikon--ikke-valgt"
    );
    cy.getByTestId("tilfredshet-ikon_1").should(
      "have.class",
      "tilfredshet-valg__ikon--ikke-valgt"
    );
